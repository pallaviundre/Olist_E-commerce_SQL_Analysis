...
The objective is to extract meaningful business insights related to sales performance, customer behavior, delivery efficiency, and customer satisfaction using MySQL.
...
- Description: Public dataset containing information on orders, customers, sellers, products, payments, reviews, and delivery details.
...
Key Insight:
Longer delivery times are strongly associated with lower customer review scores, demonstrating a direct link between operational efficiency and customer satisfaction.
---
